...
export async function POST(request: Request) {
  ...
  try {
    ...
    const defaultSettings = [
      ...
      { key: 'about_season1_text', value: 'Tahun 2025, Liga IDM Season 1 telah digelar dan berjalan sangat baik. Club-club bertarung, tim mix male & female berkompetisi, dan champion pun dinobatkan. Sambil menunggu dana terkumpul untuk season berikutnya, kami menyelenggarakan Weekly Tournament sebagai ajang berlatih dan bersaing secara individu.', type: 'text' },
