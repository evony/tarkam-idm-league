      ...
      <AnimatePresence mode="wait">
        ...
        >
          {!selectedMvp ? (
            ...
            <div
              className="perspective-card relative rounded-2xl overflow-hidden cursor-pointer group min-h-[380px] sm:min-h-[460px] border transition-all duration-300 mvp-card-glow champion-gold-frame"
            ...
            >
              ...
              <Image src={getAvatarUrl(selectedMvp.gamertag, division, selectedMvp.avatar)} alt={selectedMvp.gamertag} fill sizes="50vw" className="object-cover object-[center_25%] group-hover:scale-105 transition-transform duration-700" />
              ...
              <div className="absolute inset-0" style={{ background: `radial-gradient(ellipse at 80% 80%, ${hexToRgba(accent, 0.15)}, transparent 60%)` }} />
