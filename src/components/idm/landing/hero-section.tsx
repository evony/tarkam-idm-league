        ...
        <motion.div className="relative z-10 text-center px-4 max-w-4xl mx-auto" style={{ opacity: heroOpacity, y: contentY }}>
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            {leagueData?.ligaChampion && (
              ...
              >
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#d4a853]/20 bg-[#d4a853]/5">
                  <Crown className="w-3.5 h-3.5 text-[#d4a853]" />
                  <span className="text-[10px] font-bold text-[#d4a853]/80">S{leagueData.ligaChampion.seasonNumber} Champion:</span>
