            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-8">
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-1">
                {[
                  ...
                  <button
                    ...
                    className="text-[11px] text-muted-foreground/80 hover:text-idm-gold-warm transition-colors cursor-pointer"
                  >
                    {item.label}
                  </button>
                ))}
              ...
              {hasAnySocial && (
                <div className="flex items-center gap-2">
                  {hasDiscord && (
                    <a href={discordUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl glass border border-border/50 flex items-center justify-center text-muted-foreground/80 hover:text-idm-gold-warm hover:border-idm-gold-warm/30 transition-all" aria-label="Discord">
                  ...
                  {hasInstagram && (
                    <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl glass border border-border/50 flex items-center justify-center text-muted-foreground/80 hover:text-idm-gold-warm hover:border-idm-gold-warm/30 transition-all" aria-label="Instagram">
                  ...
                  {hasYouTube && (
                    <a href={youtubeUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl glass border border-border/50 flex items-center justify-center text-muted-foreground/80 hover:text-idm-gold-warm hover:border-idm-gold-warm/30 transition-all" aria-label="YouTube">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                  )}
                  {hasWhatsApp && (
                    <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl glass border border-border/50 flex items-center justify-center text-muted-foreground/80 hover:text-[#25D366] hover:border-[#25D366]/30 transition-all" aria-label="WhatsApp">
