            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-8">
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-1">
                {[
                  ...
                  <button
                    ...
                    className="text-[11px] text-muted-foreground/80 hover:text-[#d4a853] transition-colors cursor-pointer"
                  >
                    {item.label}
                  </button>
                ))}
              ...
              {hasAnySocial && (
                <div className="flex items-center gap-2">
                  {hasDiscord && (
                    <a href={discordUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl glass border border-border/50 flex items-center justify-center text-muted-foreground/80 hover:text-[#d4a853] hover:border-[#d4a853]/30 transition-all" aria-label="Discord">
                  ...
                  {hasInstagram && (
                    <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl glass border border-border/50 flex items-center justify-center text-muted-foreground/80 hover:text-[#d4a853] hover:border-[#d4a853]/30 transition-all" aria-label="Instagram">
                  ...
                  {hasYouTube && (
                    <a href={youtubeUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl glass border border-border/50 flex items-center justify-center text-muted-foreground/80 hover:text-[#d4a853] hover:border-[#d4a853]/30 transition-all" aria-label="YouTube">
