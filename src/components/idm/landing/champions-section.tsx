        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          {leagueData?.ligaChampion && (
            <motion.div
              ...
              className="mb-8"
            >
              <div className="relative rounded-2xl overflow-hidden border border-[#d4a853]/30" style={{ background: 'linear-gradient(135deg, #0c0a06 0%, #1a1208 25%, #0d0a06 50%, #1a0f05 75%, #0c0a06 100%)' }}>
                {/* Gold shimmer overlay */}
                <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'linear-gradient(#d4a853 1px, transparent 1px), linear-gradient(90deg, #d4a853 1px, transparent 1px)', backgroundSize: '30px 30px' }} />
                {/* Radial gold glow */}
                ...
                <div className="h-1 bg-gradient-to-r from-transparent via-[#d4a853] to-transparent" />

                <div className="relative z-10 p-6 sm:p-8">
                  {/* Header row */}
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-xl bg-[#d4a853]/15 border border-[#d4a853]/25 flex items-center justify-center" style={{ boxShadow: '0 0 40px rgba(212,168,83,0.15)' }}>
                        <Trophy className="w-6 h-6 text-[#d4a853]" />
                      </div>
                      <div>
                        <div className="flex items-center gap-2">
                          <Badge className="bg-[#d4a853]/15 text-[#d4a853] text-[9px] border border-[#d4a853]/25 font-bold uppercase tracking-wider">Liga IDM</Badge>
                        ...
                        <h3 className="text-lg sm:text-xl font-black mt-1" style={{ background: 'linear-gradient(135deg, #d4a853, #f5d78e, #d4a853)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                    ...
                    >
                      <Crown className="w-10 h-10 text-[#d4a853]/40" style={{ filter: 'drop-shadow(0 0 20px rgba(212,168,83,0.3))' }} />
                    </motion.div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-6">
                    ...
                    <div className="flex flex-col items-center text-center sm:text-left sm:flex-row gap-4 flex-1">
                      <div className="relative">
                        <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl overflow-hidden border-2 border-[#d4a853]/30 bg-[#d4a853]/5" style={{ boxShadow: '0 0 50px rgba(212,168,83,0.2)' }}>
                        ...
                        <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-[#d4a853] flex items-center justify-center shadow-lg" style={{ boxShadow: '0 0 20px rgba(212,168,83,0.5)' }}>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-[#d4a853]/80 font-semibold mt-1">Liga IDM Season {leagueData.ligaChampion.seasonNumber} Champion</p>
                        <p className="text-xs text-muted-foreground mt-1">Club mix male & female terbaik di Liga IDM Season {leagueData.ligaChampion.seasonNumber}</p>
                        ...
                        <div className="flex items-center gap-3 mt-3">
                          ...
                          <Badge className="bg-[#d4a853]/10 text-[#d4a853] text-[10px] border-[#d4a853]/20 px-2.5 py-1">
                            <Users className="w-3 h-3 mr-1" />
                      ...
                      <div className="flex flex-wrap justify-center sm:justify-start gap-2">
                        {leagueData.ligaChampion.members.slice(0, 5).map((member: { id: string; gamertag: string; division: string; role: string; avatar?: string | null }, i: number) => (
                          ...
                          >
                            <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-xl overflow-hidden border-2 transition-all duration-200 hover:scale-110 cursor-default ${
                            ...
                            } ${member.role === 'captain' ? 'ring-2 ring-[#d4a853]/50 border-[#d4a853]/30' : ''}`}>
                              <Image
                              ...
                              {/* Captain badge */}
                              {member.role === 'captain' && (
                                <div className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-[#d4a853] flex items-center justify-center z-10">
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    <div className="h-px flex-1 bg-gradient-to-r from-[#d4a853]/20 to-transparent" />
                    <div className="flex items-center gap-1.5 text-[#d4a853]/40">
                      <Trophy className="w-3 h-3" />
                      <span className="text-[9px] font-bold uppercase tracking-[0.2em]">Liga IDM Champion</span>
                      <Trophy className="w-3 h-3" />
                    </div>
                    <div className="h-px flex-1 bg-gradient-to-l from-[#d4a853]/20 to-transparent" />
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              return (
                ...
                >
                  {(!data || !data.weeklyChampions?.length) ? (
                    <Card className="overflow-hidden border card-shine champion-gold-frame" style={{ borderColor: `${accent}20` }}>
                      ...
                      <CardContent className="p-0">
                        <div className="relative h-28 sm:h-36 overflow-hidden">
                          ...
                          <div className="absolute top-3 left-3 w-8 h-8 border-t border-l" style={{ borderColor: `${accent}20` }} aria-hidden="true" />
                          <div className="absolute top-3 right-3 w-8 h-8 border-t border-r" style={{ borderColor: `${accent}20` }} aria-hidden="true" />
                          ...
                          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                            ...
                            >
                              <Crown className="w-14 h-14" style={{ color: `${accent}25`, filter: `drop-shadow(0 0 24px ${accent}20)` }} />
                            </motion.div>
                          </div>
                        ...
                        {/* Gold divider line */}
                        <div className="h-px bg-gradient-to-r from-transparent via-[#d4a853]/25 to-transparent" />
                        <div className="p-6 text-center space-y-4">
                          ...
                          <div className="flex justify-center gap-2">
                            {[1, 2, 3].map(i => (
                              <div key={i} className="w-24 h-16 rounded-xl border border-dashed flex items-center justify-center card-shine" style={{ borderColor: `${accent}20`, background: `linear-gradient(135deg, ${accent}06 0%, transparent 50%, ${accent}04 100%)` }}>
                                <span className="text-[10px] font-bold" style={{ color: `${accent}35` }}>#{i}</span>
                              </div>
                            ))}
                          </div>
                        </div>
                    ...
                    return (
                      <Card className="overflow-hidden border card-shine champion-gold-frame card-border-glow group transition-all duration-500 hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(212,168,83,0.2)]" style={{ borderColor: `${accent}20` }}>
                        {/* Gold accent line — thicker, more premium */}
                        <div className="h-1 bg-gradient-to-r from-transparent via-current to-transparent" style={{ color: accent }} />
                        <CardContent className="p-0">
                          {/* Banner Header — reduced height for more avatar space */}
                          <div className="relative h-28 sm:h-36 overflow-hidden">
                            <img
                              src="/bg-section.jpg"
                              alt=""
                            ...
                            <div className="absolute top-4 right-6">
                              <motion.div animate={{ y: [0, -3, 0] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}>
                                <Crown className="w-8 h-8 trophy-float" style={{ color: accentLight, filter: `drop-shadow(0 0 16px ${accent}80)` }} />
                              </motion.div>
                            </div>
                          ...
                          <div className="p-5 space-y-4">
                            ...
                            <div className="relative flex items-center justify-between">
                              ...
                              <div className="relative flex items-center gap-2">
                                {selected.prizePool > 0 && (
                                  <span className="text-[11px] font-bold text-[#d4a853] bg-gradient-to-r from-[#d4a853]/15 to-[#d4a853]/5 px-3 py-1.5 rounded-lg flex items-center gap-1 border border-[#d4a853]/20"><Wallet className="w-3.5 h-3.5" />{selected.prizePool.toLocaleString()}</span>
                                )}
                                {selected.mvp && (
                                  <span className="mvp-badge-premium glow-pulse text-xs font-bold text-[#d4a853] bg-gradient-to-r from-[#d4a853]/20 via-[#d4a853]/10 to-[#d4a853]/20 px-3 py-1.5 rounded-lg flex items-center gap-1.5 border border-[#d4a853]/25">
                            ...
                            {/* 3 Player Avatars — shorter & wider layout */}
                            {selected.winnerTeam && selected.winnerTeam.players.length > 0 ? (
                              <div className="relative flex rounded-2xl overflow-hidden border" style={{ height: '190px', borderColor: `${accent}15` }}>
                                {/* CHAMPION gold watermark behind avatars */}
                                <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0" aria-hidden="true">
                                  <span className="text-4xl font-black uppercase tracking-[0.15em] select-none" style={{ color: 'rgba(212,168,83,0.04)', WebkitTextStroke: '1px rgba(212,168,83,0.06)' }}>CHAMPION</span>
                                </div>
                                {selected.winnerTeam.players.slice(0, 3).map((player: { id: string; gamertag: string; avatar: string | null; tier: string; points: number; totalWins: number; streak: number }, pIdx: number) => (
                                  ...
                                  >
                                    ...
                                    {pIdx < 2 && <div className="absolute right-0 top-4 bottom-4 w-px z-20" style={{ backgroundColor: `${accent}15` }} />}
                                    <div className="absolute top-2 left-2 z-10">
                                      <div className="w-6 h-6 rounded-md flex items-center justify-center text-[10px] font-black backdrop-blur-sm" style={{ backgroundColor: `${accent}30`, color: accentLight }}>
                                        {pIdx + 1}
                                      </div>
                                    </div>
                                    <div className="absolute bottom-0 inset-x-0 px-2.5 pb-2.5 pt-6 z-10" style={{ background: 'linear-gradient(to top, rgba(12,10,6,0.85) 0%, transparent 100%)' }}>
                                      ...
                                      <div className="flex items-center gap-1.5 mt-0.5">
                                        ...
                                        {pIdx === 0 && <span className="text-[8px] font-bold px-1 py-0.5 rounded" style={{ color: accentLight, backgroundColor: `${accent}25` }}>CPT</span>}
                                      </div>
                                      <div className="flex items-center gap-1.5 mt-0.5">
